...
export const QUEUE_NAME = "recovery-jobs";

export const recoveryQueue = new Queue<RecoveryJobPayload>(QUEUE_NAME, {
  connection: redisConnection,
  defaultJobOptions: {
    attempts: 2, // retry the entire job on worker crash
...
/**
 * Redis key used to signal tool results back to the waiting worker.
